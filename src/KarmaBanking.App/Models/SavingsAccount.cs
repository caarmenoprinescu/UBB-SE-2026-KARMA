...
namespace KarmaBanking.App.Models
{
    ...
    public class SavingsAccount
    {
        ...
        /// <summary>
        /// Gets or sets the current balance of the savings account, which represents the total amount of money currently saved in the account.
        /// </summary>
        public decimal Balance { get; set; }

        /// <summary>
        /// Gets or sets the total amount of interest that has been accrued on the savings account but has not yet been added to the balance.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the maturity date for fixed deposit accounts, which indicates when the funds will be available without penalty and when interest will be added to the balance.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the optional name of the savings account, which can be used by users to easily identify and differentiate between multiple accounts.
        /// </summary>
        ...
        /// This provides users with an estimate of how much interest they can expect to earn in a month if the balance remains unchanged.
        /// </summary>
